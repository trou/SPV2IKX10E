...
static struct fb_videomode truly_lcd_modedb[] = {
	{
	 "TRULY-WVGA", 62, 480, 800, 36496,
	 36, 10,
	 10, 2,
	 2, 1,
	 FB_SYNC_OE_LOW_ACT | FB_SYNC_CLK_LAT_FALL,
...
static int mipid_init_gpios(struct mipi_dsi_info *mipi_dsi)
{
	...
	gpio_direction_output(DISPLAY_POWER_PIN, 1);
...
//	DCS_LCMD_PARAM2(0xEB, 0x00, 0x0F); 			 // DSI Lanes Control, one 1 lane
	...
	msleep(10);											//also this should have more parameters
...
////	DCS_LCMD_PARAM4(0xB5, 0x08, 0x0B, 0x14, 0x0);		// Blanking porch control, VFP=8, VBP=11, HBP=20
//	msleep(10);
//

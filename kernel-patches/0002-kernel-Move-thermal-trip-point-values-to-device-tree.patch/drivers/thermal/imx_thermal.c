...
#define IMX_TEMP_PASSIVE_COOL_DELTA		6000

#define IMX_TEMP_CRITICAL				105000 /* Temperature where i.MX6 stops working */
			     ...
			     unsigned long temp)
{
	...
	if (trip == IMX_TRIP_PASSIVE) {
              /* BSH: Remove check to be able to set own values via sysfs
               *
...
static int imx_get_sensor_data(struct platform_device *pdev)
{
	...
	/*
	 * Set the default critical trip point
	 */
